...
void Birthday_99_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Birthday_99_run(uint ctx_index,Circom_CalcWit* ctx);
...
Birthday_99_create(1,0,ctx,"main",0);
Birthday_99_run(0,ctx);
}
